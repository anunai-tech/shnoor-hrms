...
import { getMyAttendance, getMyLeaves } from '../../services/managerService'
  ...
  return (
    <div className="mt-4">
      ...
      <div className="relative h-2 bg-gray-100 rounded-full overflow-hidden">
        <div className={`h-full rounded-full transition-all duration-1000 ${overtime ? 'bg-orange-400' : 'bg-green-400'}`}
          style={{ width: `${pct}%` }} />
      </div>
...
function SelfDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl font-bold text-gray-800">My Dashboard</h1>
