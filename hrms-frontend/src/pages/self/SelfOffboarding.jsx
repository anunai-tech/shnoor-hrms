...
import { getMyOffboarding, submitResignation, getMyComplaints, raiseComplaint, getMyLetters } from '../../services/managerService'
                  ...
                  <div key={c.id} className="px-6 py-5">
                    ...
                    {c.manager_response && (
                      <div className="mt-3 bg-amber-50 rounded-lg px-4 py-3">
                        <p className="text-xs text-primary font-medium mb-1">Manager Response</p>
...
export default SelfOffboarding