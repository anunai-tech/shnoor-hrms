      ...
      {showEditModal && selectedEmployee && (
        <Modal title={`Edit Salary — ${selectedEmployee.first_name} ${selectedEmployee.last_name}`} onClose={() => setShowEditModal(false)}>
          ...
          <div className="flex gap-3 mt-6">
            <button onClick={handleSave} className="font-display flex-1 bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold py-2.5 rounded-lg transition">Save</button>
