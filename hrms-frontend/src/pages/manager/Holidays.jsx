      ...
      {showAddModal && (
        <Modal title="Add New Holiday" onClose={() => setShowAddModal(false)}>
          ...
          <div className="flex gap-3 mt-6">
            <button onClick={handleAdd} className="flex-1 bg-primary hover:opacity-90 text-white text-sm font-semibold py-2.5 rounded-lg transition">Add Holiday</button>
