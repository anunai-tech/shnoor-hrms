  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="font-body text-sm text-gray-400 mt-1">Manage your account settings</p>
      </div>

      {/* Account Info */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 className="font-display text-base font-semibold text-gray-800 mb-5 pb-3 border-b border-gray-100">Account Information</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <span className="font-display inline-block bg-yellow-50 text-yellow-600 text-xs font-semibold px-3 py-1 rounded-full">
              Super Admin
            </span>
          </div>
        </div>
      ...
      {/* Change Password */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 className="font-display text-base font-semibold text-gray-800 mb-5 pb-3 border-b border-gray-100">Change Password</h2>

        {passwordError && (
          <div className="font-body bg-red-50 border border-red-200 text-red-600 text-sm rounded-lg px-4 py-3 mb-4">{passwordError}</div>
        )}
        {passwordSuccess && (
          <div className="font-body bg-green-50 border border-green-200 text-green-600 text-sm rounded-lg px-4 py-3 mb-4">Password changed successfully!</div>
        )}
        ...
        <div className="space-y-4 max-w-md">
          ...
          <div>
            <label className="font-display block text-sm font-medium text-gray-700 mb-1">Confirm New Password</label>
          ...
          <button onClick={handlePasswordSave} disabled={saving}
            className="font-display bg-yellow-400 hover:bg-yellow-500 disabled:bg-yellow-200 text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition">
      ...
      {/* System Info */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 className="font-display text-base font-semibold text-gray-800 mb-5 pb-3 border-b border-gray-100">System Information</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div>
            <label className="font-display block text-xs text-gray-400 font-medium mb-1">Version</label>
            <p className="font-display text-sm font-semibold text-gray-800">SHNOOR HRMS v1.0</p>
          </div>
          <div>
            <label className="font-display block text-xs text-gray-400 font-medium mb-1">Support</label>
