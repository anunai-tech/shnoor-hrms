        ...
        <div className="flex items-center gap-6 mb-8 pb-6 border-b border-gray-100">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="relative">
              ...
              {/* Upload button */}
              <label className={`absolute bottom-0 right-0 w-7 h-7 bg-yellow-400 rounded-full flex items-center justify-center cursor-pointer hover:bg-yellow-500 transition ${uploading ? 'opacity-50 pointer-events-none' : ''}`}>
