  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="font-body text-sm text-gray-400 mt-1">View your attendance history</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {attendance.length === 0 ? (
                <tr><td colSpan="4" className="font-body text-center py-10 text-sm text-gray-400">No attendance records yet</td></tr>
              ) : (
