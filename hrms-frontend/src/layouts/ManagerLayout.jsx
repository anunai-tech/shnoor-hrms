        ...
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`flex-1 py-3 text-sm font-semibold transition-all
              ${activeTab === 'self' ? 'text-primary border-b-2 border-primary' : 'text-gray-400 hover:text-gray-600'}`}>
            Self
          </button>
          <button
            onClick={() => { setActiveTab('manager'); navigate('/manager/dashboard') }}
            className={`flex-1 py-3 text-sm font-semibold transition-all
              ${activeTab === 'manager' ? 'text-primary border-b-2 border-primary' : 'text-gray-400 hover:text-gray-600'}`}>
            Manager
          </button>
        </div>
